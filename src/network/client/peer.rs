...
//! The `peer` module provides the Yobicash network client `Peer` methods.
...
impl<S: Store, T: Connection + Read + Write> Client<S, T> {
    /// Lists a node peers.
    pub fn list_peer(&mut self,
                             addr: &str,
                             timeout: Option<u64>,
                             read_timeout: Option<u64>,
                             write_timeout: Option<u64>) -> Result<Vec<Digest>> {

        let resource_type = ResourceType::Peer;
    ...
    /// Samples a node peers.
    pub fn sample_peers(&mut self,
                                addr: &str,
                                timeout: Option<u64>,
                                read_timeout: Option<u64>,
    ...
    pub fn get_peer(&mut self,
        ...
        Peer::from_bytes(&res.resource)
    }

    /// Lookups a node peer.
    pub fn lookup_peer(&mut self,
                       addr: &str,
                       timeout: Option<u64>,
                       read_timeout: Option<u64>,
                       write_timeout: Option<u64>,
