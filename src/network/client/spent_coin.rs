...
//! The `spent_coin` module provides the Yobicash network client `SpentCoin` methods.
...
impl<S: Store, T: Connection + Read + Write> Client<S, T> {
    /// Lists a node spent coins.
    pub fn list_spent_coins(&mut self,
                             addr: &str,
                             timeout: Option<u64>,
                             read_timeout: Option<u64>,
                             write_timeout: Option<u64>) -> Result<Vec<Digest>> {

        let resource_type = ResourceType::SpentCoin;
    ...
    /// Samples a node spent coins.
    pub fn sample_spent_coins(&mut self,
                                addr: &str,
                                timeout: Option<u64>,
                                read_timeout: Option<u64>,
    ...
    pub fn get_spent_coin(&mut self,
               addr: &str,
               timeout: Option<u64>,
               read_timeout: Option<u64>,
               write_timeout: Option<u64>,
    ...
    /// Lookups a node spent coin.
    pub fn lookup_spent_coin(&mut self,
                             addr: &str,
                             timeout: Option<u64>,
                             read_timeout: Option<u64>,
                             write_timeout: Option<u64>,
