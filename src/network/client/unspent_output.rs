...
//! The `unspent_output` module provides the Yobicash network client `UnspentOutput` methods.
...
impl<S: Store, T: Connection + Read + Write> Client<S, T> {
    /// Lists a node unspent outputs.
    pub fn list_unspent_outputs(&mut self,
                             addr: &str,
                             timeout: Option<u64>,
                             read_timeout: Option<u64>,
                             write_timeout: Option<u64>) -> Result<Vec<Digest>> {

        let resource_type = ResourceType::UnspentOutput;
    ...
    /// Samples a node unspent outputs.
    pub fn sample_unspent_outputs(&mut self,
                                addr: &str,
                                timeout: Option<u64>,
                                read_timeout: Option<u64>,
    ...
    /// Lookups a node unspent output.
    pub fn lookup_unspent_output(&mut self,
                                 addr: &str,
                                 timeout: Option<u64>,
                                 read_timeout: Option<u64>,
                                 write_timeout: Option<u64>,
    ...
    /// Put an unspent output to the node.
    pub fn put_unspent_output(&mut self,
                              addr: &str,
                              timeout: Option<u64>,
                              read_timeout: Option<u64>,
                              write_timeout: Option<u64>,
