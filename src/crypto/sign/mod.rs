...
pub fn check_seed_size(sig: &Seed) -> YResult<()> {
...
pub fn check_public_key_size(pk: &PublicKey) -> YResult<()> {
...
pub fn check_message_size(sig: &Message) -> YResult<()> {
...
pub fn check_signature_size(sig: &Signature) -> YResult<()> {
